...
export default function Latest(){
    ...
    return(
        <div className="w-screen h-[670px] flex justify-center items-center "> 
            <div className="w-[85%] h-[539px] flex flex-col justify-between">
                <div className="w-[100%] h-[86px]  flex justify-between items-center ">
                    <div className="h-[20px] relative">
                        <p className="font-semibold text-2xl absolute top-[-13px] z-20 fontfamily ">جدید ترین ها</p>

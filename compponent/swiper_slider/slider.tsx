    ...
    <div className='w-screen'>
      <Swiper navigation={true} modules={[Navigation]}   >
        <SwiperSlide >
          ...
          <p className='fontjavan text-8xl font-normal text-[#FFFFFF] leading-[120px] w-[410px] '>تجربه</p>
          <p className='fontjavan text-8xl font-normal text-[#FFFFFF]'>عسل طبیعی</p>
          <div className='w-[417px]  h-[163px] flex items-center'>
            <button className='w-[212px] h-[68px] bg-[#FFA51F] rounded-[20px] fontfamily text-[#2C2C2C] text-base font-semibold '>خرید </button>
          </div>
          </div>
          </div>
        </SwiperSlide>

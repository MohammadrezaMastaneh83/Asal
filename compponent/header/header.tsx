  ...
  return (
    <div className="w-screen  flex flex-col items-center ">
        ...
        <div className="w-[357px] h-[45px] flex gap-[16px]">
          <div className="w-[245px] h-[40px]  border-[#FFA51F] border-[1px] rounded-[10px] flex  gap-[10px]  bg-[#ffffff] px-[15px] ">
            ...
            <input
              ...
              className="w-[200px] h-[38px] text-[#FFA51F] rounded-[10px]  font-[Light] bg-[#ffffff] outline-none placeholder-[#FFA51F] "
            />
          </div>
      ...
      <div className="h-[54px] w-screen bg-[#FFF0D9] flex justify-between">
        <div className="flex">
          <div
            style={{ boxShadow: "(-4px 0px 10px rgba(0, 0, 0, 0.15))" }}
            className="w-[340px] h-[54px] bg-[#FFA51F]  clip-path-left flex justify-center items-center gap-[10px] shadow-[-4px_0px_10px_0px_rgba(0,0,0,0.15)]"
          >
            <img src="/category.svg" alt="" className="w-[28px]" />
            <p className="text-[#FFFFFF] font-semibold fontfamily">
              دسته بندی محصولات
            </p>
        ...
        <div className="flex">
          <div className="flex items-center h-[54px] gap-[8px] ">
            <p className="font-medium fontfamily text-[#8F8F8F] text-sm">
              پشتـیبانی فـروش
            </p>
            <p className="fontfamily font-semibold text-base text-[#343434]">
              09125406306
            </p>
          </div>

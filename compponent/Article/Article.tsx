...
export default function Article() {
    const Article = [
        {
            title: "کپسول ژل رویال",
            detail: "یک قاشق چایخوری عسل طبیعی زنبور عسل حاوی حدود 5-6 گرم قند است؛ اما این مقدار چه سهمی در نیاز روزانه بدن انسان ...",
                ...
                <div className="w-[100%] h-[435px]  flex items-center ">
                    <div ref={sliderRef} className="keen-slider  ">
                        {Article.map((item, index) => {
                            return (
                                <div className="keen-slider__slide number-slide1 w-[605px] h-[320px]">
                                    <div className="w-[100%]  flex justify-between h-[350px]">
                                        <div className="w-[300px] h-[350px] ">
                                            <p className="text-[#2C2C2C] font-extrabold text-[24px] leading-[24px] fontfamily ">{item.title}</p>
                                            <p className="text-[#797777] font-medium text-[16px] leading-[32px] fontfamily mt-[70px] w-[235px]">{item.detail}</p>
                                            <button className="w-[134px] h-[46px] text-[#FFA51F] text-[24px] font-semibold fontfamily border-[#FFA51F] rounded-[10px] mt-[24px] border-[1px]">ادامه مطالب</button>
                                        </div>

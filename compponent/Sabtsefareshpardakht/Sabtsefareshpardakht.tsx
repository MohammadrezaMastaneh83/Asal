...
export default function Sabtsefareshpardakht() {
  return (

    <>
     <div className="w-[23.25rem] h-[22.37rem] bg-[#FFFFFF] shadow-md rounded-[20px]">
        <h3 className="text-[1.5rem] font-xregular text-[#FFA51F] p-5 flex justify-end">
          اطلاعات پرداخت
        </h3>
        <div className="-mt-5">
          <div className="flex justify-between flex-row-reverse p-5">
